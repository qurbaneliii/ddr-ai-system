...
The code and public demo are verified. Final production-persistence compliance remains blocked until an authorized PostgreSQL `DDR_DATABASE_URL` is configured, seeded, and restart-tested; the live app truthfully reports temporary SQLite mode.
